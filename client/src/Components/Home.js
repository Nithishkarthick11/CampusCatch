            ...
            >
                ...
                >
                    ...
                    <Typography color="#FEF0E9">
                     A platform through which students can find those items that are so important to them in college campus. 
                    <br />
                      It helps students to be able to publish their lost item or if they find one, help them find their owner!
                    </Typography>
                    <Stack
                        sx={{
                            flexDirection: 'row',
